        ...
        return [
            'it' => [
                ...
                'manage_page' => [
                    ...
                    'info_message'   => 'Per modifiche o annullo contatta il ristorante rispondendo alla mail di conferma.',
                    'actions' => [
                        'legend'              => 'Richiedi un\'azione',
                        'select_action'       => 'Seleziona azione',
                        'select_placeholder'  => '-- Seleziona un\'azione --',
                        'cancel_request'      => 'Richiedi annullo',
                        'change_time_request' => 'Richiedi modifica orario',
                        'desired_time'        => 'Nuovo orario desiderato',
                        'desired_time_hint'   => 'Indica l\'orario preferito per la tua prenotazione',
                        'staff_note'          => 'Nota per lo staff (opzionale)',
                        'staff_note_placeholder' => 'Aggiungi eventuali dettagli o richieste specifiche...',
                        'submit'              => 'Invia richiesta',
                        'disabled_hint'       => 'Le azioni non sono disponibili per questo stato.',
                    ],
                    'validation' => [
                        'select_action'   => 'Seleziona un\'azione prima di inviare.',
                        'specify_time'    => 'Specifica il nuovo orario desiderato.',
                        'confirm_request' => 'Confermi l\'invio della richiesta?',
                    ],
                ],
                'survey' => [
                    'labels' => [
            ...
            'en' => [
                ...
                'manage_page' => [
                    ...
                    'info_message'   => 'To modify or cancel, contact the restaurant by replying to the confirmation email.',
                    'actions' => [
                        'legend'              => 'Request an action',
                        'select_action'       => 'Select action',
                        'select_placeholder'  => '-- Select an action --',
                        'cancel_request'      => 'Request cancellation',
                        'change_time_request' => 'Request time change',
                        'desired_time'        => 'Desired new time',
                        'desired_time_hint'   => 'Indicate your preferred time for the reservation',
                        'staff_note'          => 'Note for staff (optional)',
                        'staff_note_placeholder' => 'Add any details or specific requests...',
                        'submit'              => 'Send request',
                        'disabled_hint'       => 'Actions are not available for this status.',
                    ],
                    'validation' => [
                        'select_action'   => 'Select an action before submitting.',
                        'specify_time'    => 'Specify the desired new time.',
                        'confirm_request' => 'Confirm sending the request?',
                    ],
                ],
                'survey' => [
                    'labels' => [
