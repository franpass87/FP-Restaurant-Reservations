        ...
        switch ($field['type']) {
            ...
            case 'meal_plan':
                ...
                $strings = [
                    ...
                    'dateFromLabel'  => __('Data inizio (opzionale)', 'fp-restaurant-reservations'),
                    'dateToLabel'    => __('Data fine (opzionale)', 'fp-restaurant-reservations'),
                    'dateRangeHint'  => __('Se impostate, il pasto è prenotabile solo in questo intervallo (inclusivo). Lasciare vuoto per nessun limite.', 'fp-restaurant-reservations'),
