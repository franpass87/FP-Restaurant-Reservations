...
final class AdminController
{
    ...
    public function enqueueAssets(string $hook): void
    {
        ...
        wp_localize_script($scriptHandle, 'fpResvClosuresSettings', [
            ...
            'preview'  => $preview,
            'strings'  => [
                'headline'    => __('Chiusure e Aperture Speciali', 'fp-restaurant-reservations'),
                'description' => __('Gestisci chiusure temporanee, riduzioni di capienza e aperture straordinarie per eventi speciali.', 'fp-restaurant-reservations'),
                'createCta'   => __('Nuova chiusura/apertura', 'fp-restaurant-reservations'),
                'empty'       => __('Nessuna chiusura o apertura programmata nel periodo selezionato.', 'fp-restaurant-reservations'),
                'formTitle'   => __('Nuova chiusura/apertura', 'fp-restaurant-reservations'),
