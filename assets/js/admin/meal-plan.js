/**
 * Meal plan editor (admin).
 * Costanti inline (prima in meal-plan-config.js via import ES module): su alcuni hosting
 * l'import relativo del secondo file fallisce e l'editor non si monta (area vuota).
 */
